      ...
      <form onSubmit={handleSignIn}>
        {step === 1 ? (
          <>
            ...
            <button
              onClick={() => setStep(2)}
              className="mt-6 py-2 px-6 bg-gradient-to-tr from-gray-700 to-gray-900 text-white rounded-lg font-bold w-full transition-all duration-500 hover:from-gray-700 hover:to-black hover:scale-105"
            >
              Next
            </button>
          </>
          ...
          <div className="gap-4 w-[23rem]">
            <button className="absolute top-10 left-6 flex justify-center items-center w-12 h-12 border-2 text-white border-white rounded-full hover:bg-white hover:text-black transtition-all duration-500 group">
              <IconArrowLeft className="w-6 h-6 group-hover:-translate-x-1 transition-all duration-300" onClick={() => setStep(1)} />
            </button>
            ...
            <input
              ...
              className="mb-4 w-full p-3 rounded-lg border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
            <Link href={"/home"}>
